const Header = ({ cart, removeFromCart, increanseQuantity, decreaseQuantity, clearCart, isEmpty, cartTotal }) => {
  return (
                        ...
                        {cart.map((guitar) => (
                          <tr key={guitar.id}>
                            ...
                            <td className="flex align-items-start gap-4">
                              ...
                              {guitar.quantity}
                              <button type="button" className="btn btn-dark" onClick={ () => increanseQuantity(guitar.id) }>
                                +
                              </button>
                            </td>
